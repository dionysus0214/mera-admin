...
<%@include file="../include/headerTop.jsp"%>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/app-assets/css/pages/error.css">
    <!-- END: Page CSS-->
                    ...
                    <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                        <div class="card-content">
                            <div class="card-body text-center">
                                <img src="/resources/app-assets/images/pages/500.png" class="img-fluid align-self-center" alt="branding logo">
