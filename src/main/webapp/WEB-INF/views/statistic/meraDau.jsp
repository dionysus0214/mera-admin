...
<%--                </div>--%>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">DAU(Daily Active User)</h4>
                            </div>
                            <div class="card-content">
...
<%--                                            <h5 class="text-bold-500">End Date Range</h5>--%>
                                        ...
                                        <div class="col-md-2 col-12 mb-1">
                                            <a href="javascript:update()" class="btn btn-outline-primary float-left btn-inline">Update</a>
                                        </div>
                                    </div>
...
<script>
    ...
    function update() {
        ...
        reportService.getList("/report/getDAU", itemObj, function(data) {
            $("#dauViewTable").html(data);
