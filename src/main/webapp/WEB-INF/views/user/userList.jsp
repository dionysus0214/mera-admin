...
<%@include file="../include/headerTop.jsp"%>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/app-assets/vendors/css/tables/datatable/extensions/dataTables.checkboxes.css">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="/resources/app-assets/css/pages/data-list-view.css">
    <!-- END: Page CSS-->
            ...
            <section id="data-thumb-view" class="data-thumb-view-header">
                ...
                <div class="table-responsive">
                    <table class="table data-thumb-view">
                        ...
                        <tr>
                            <td></td>
                            <td class="product-img"><img src="/resources/app-assets/images/elements/apple-watch.png" alt="Img placeholder">
                            </td>
                        ...
                        <tr>
                            <td></td>
                            <td class="product-img"><img src="/resources/app-assets/images/elements/magic-mouse.png" alt="Img placeholder">
                            </td>
                        ...
                        <tr>
                            <td></td>
                            <td class="product-img"><img src="/resources/app-assets/images/elements/iphone-x.png" alt="Img placeholder">
                            </td>
                        ...
                        <tr>
                            <td></td>
                            <td class="product-img"><img src="/resources/app-assets/images/elements/ipad-pro.png" alt="Img placeholder">
                            </td>
                        ...
                        <tr>
                            <td></td>
                            <td class="product-img"><img src="/resources/app-assets/images/elements/jbl-speaker.png" alt="Img placeholder">
                            </td>
                        ...
                        <tr>
                            <td></td>
                            <td class="product-img"><img src="/resources/app-assets/images/elements/beats-headphones.png" alt="Img placeholder">
                            </td>
                        ...
                        <tr>
                            <td></td>
                            <td class="product-img"><img src="/resources/app-assets/images/elements/homepod.png" alt="Img placeholder">
                            </td>
                        ...
                        <tr>
                            <td></td>
                            <td class="product-img"><img src="/resources/app-assets/images/elements/macbook-pro.png" alt="Img placeholder">
                            </td>
...
<script src="/resources/app-assets/vendors/js/tables/datatable/dataTables.select.min.js"></script>
<script src="/resources/app-assets/vendors/js/tables/datatable/datatables.checkboxes.min.js"></script>
<!-- END: Page Vendor JS-->


<!-- BEGIN: Page JS-->
<script src="/resources/app-assets/js/scripts/ui/data-list-view.js"></script>
<!-- END: Page JS-->
